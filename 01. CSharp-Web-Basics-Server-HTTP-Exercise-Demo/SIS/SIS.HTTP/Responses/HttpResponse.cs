...
namespace SIS.HTTP.Responses
{
    public class HttpResponse : IHttpResponse
    {
        ...
        public HttpResponse()
        {
            ...
            this.HttpCookies = new HttpCookieCollection();
        ...
        public IHttpCookieCollection HttpCookies { get; set; }
        
        public void AddCookie(HttpCookie cookie)
        {
            CoreValidator.ThrowIfNull(cookie, nameof(cookie));
            this.HttpCookies.AddCookie(cookie);
        }
        ...
        public override string ToString()
        {
            ...
            if (this.HttpCookies.HasCookies())
            {
                result.Append($"Set-Cookie: {this.HttpCookies}").Append(GlobalConstants.HttpNewLine);
            }
